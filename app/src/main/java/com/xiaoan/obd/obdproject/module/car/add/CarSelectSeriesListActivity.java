 ...
 */
@RequiresPresenter(CarSelectSeriesListPresenter.class)
public class CarSelectSeriesListActivity extends BeamListActivity<CarSelectSeriesListPresenter,CarBean>{
    @Override
